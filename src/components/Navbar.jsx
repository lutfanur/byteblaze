    ...
    return (
        <div className="navbar bg-base-100 shadow-lg px-4 sm:px-8 fixed z-10">
            ...
            <div className="flex-none gap-2">
                <ul className="menu menu-horizontal px-1 hidden sm:flex   items-center gap-6">
                    <NavLink to='/' className={({ isActive }) =>
                        isActive ? 'text-primary font-bold' : 'font-bold'}>Home
                    </NavLink>
                    <NavLink to='/blogs' className={({ isActive }) =>
                        isActive ? 'text-primary font-bold' : 'font-bold'}>Blogs
                    </NavLink>
                    <NavLink to='/bookmarks' className={({ isActive }) =>
                        isActive ? 'text-primary font-bold' : 'font-bold'}>Bookmarks
                    </NavLink>
                </ul>
